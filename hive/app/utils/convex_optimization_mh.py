...
def main():
    ...
    print(f"\nUsing Semidefinite Programming techniques... The optimal eigenvalue is: {eigenvalue}\n")
    ...
    print(f"Using Global Optimization techniques... The matrix normal is: {eigenvalue}")
