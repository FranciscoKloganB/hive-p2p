...
class SimpleHiveNode(BaseNode):
    ...
    def send_part(
        ...
        Args:
            hive:
                Gateway BaseCluster that will deliver this file to other
                worker. In a real world implementation this argument would
                not be needed, but we use it to facilitate simulation management
    ...
    def receive_part(self, part: FileBlockData) -> int:
        ...
        if crypto.sha256(part.data) != part.sha256:
            ...
            # reject repeated replicas even if they are correct
