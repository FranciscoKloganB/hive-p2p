...
class Worker:
    ...
    Workers work in one or more hives (:py:class:`~domain.cluster_groups.BaseHive`) to try
    ...
    generated by (:py:meth:`~domain.cluster_groups.BaseHive.new_transition_matrix`). If
    every worker in the BaseHive shares their blocks with other members by
    ...
    Attributes:
        ...
        uptime:
            ...
            BaseHive as a replacement for some other Worker,
            in :py:meth:`~domain.cluster_groups.BaseHive._membership_maintenance`,
            the time the worker has been online is not considered. Thus,
            if a Worker belongs to only one BaseHive he is guaranteed to remain
        ...
        hives:
            A collection of :py:class:`~domain.cluster_groups.BaseHive` this Worker is a
            member of.
        files:
    ...
    def remove_file_routing(self, fid: str) -> None:
        ...
        This method is called when a Worker is evicted from the BaseHive and
