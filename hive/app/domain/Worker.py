...
class Worker:
    ...
    Workers work in one or more hives (:py:class:`~domain.Hive.Hive`) to try
    ...
    generated by (:py:meth:`~domain.Hive.Hive.new_transition_matrix`). If
    ...
    Attributes:
        ...
        uptime:
            ...
            in :py:meth:`~domain.Hive.Hive._membership_maintenance`,
        ...
        hives:
            A collection of :py:class:`~domain.Hive.Hive` this Worker is a
            member of.
        files:
