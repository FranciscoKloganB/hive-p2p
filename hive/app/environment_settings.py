...
Note:
    ...
    :py:class:`~app.domain.network_nodes.HiveNode`), the number of network nodes
    in a group persisting a file (
    :py:class:`~app.domain.cluster_groups.Cluster`),
    the way files are initially distributed between network nodes of a
    simulation (:py:meth:`~app.domain.cluster_groups.Cluster.spread_files`) and,
...
Attributes:
    ...
    MIN_CONVERGENCE_THRESHOLD:
        ...
        :py:class:`~app.domain.cluster_groups.Cluster` must converge before epochs
    ...
    ABS_TOLERANCE:
        ...
        :py:func:`~app.domain.cluster_groups.Cluster.cv_` can have from the
        desired steady state :py:func:`~app.domain.cluster_groups.Cluster.v_`,
        ...
        :py:func:`~app.domain.cluster_groups.Cluster.v_`.
"""
import os
