...
An overlay is said to be \textbf{\textit{connected}} if there is a path that allows any pair of peers \textit{i, j} to communicate with each other, i.e., there is no partitioning and no peer is isolated in the system.
